...
class CropLayout @JvmOverloads constructor(
    ...
    init {
        ...
        try {
            ...
            defaultCropImageView.layoutParams = LayoutParams(WRAP_CONTENT, MATCH_PARENT, Gravity.CENTER)
    ...
    fun crop() {
        if (isOffFrame()) {
            Log.w(TAG, "Please replace an image inside frame.")
            return
        }
